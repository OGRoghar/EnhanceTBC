...
local function CreateIconsFrame()
  ...
  frame.friends_texture.icon:SetAllPoints()
  ...
  frame.guild_texture.icon:SetAllPoints()
  ...
  frame.inventory_text_texture.icon:SetAllPoints()
  ...
  frame.durability_text_texture.icon:SetAllPoints()
